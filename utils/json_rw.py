...
from ..config.config import MAX_STAMINA
from .Artifact import ARTIFACT_LIST

FILE_PATH = os.path.dirname(__file__)
USER_INFO_PATH = os.path.join(FILE_PATH, "../data/user_info.json")
...
with open(USER_INFO_PATH, "r", encoding="UTF-8") as f:
    ...
    for uid in user_info.keys():
        ...
        for artifact in user_info[uid]["warehouse"]:
            ...
            if (suit_name in ARTIFACT_LIST) and (
                artifact_name in ARTIFACT_LIST[suit_name]["element"]
            ):
